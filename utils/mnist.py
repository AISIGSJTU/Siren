...
def data_mnist(one_hot=True):
    ...
    if gv.args.dataset == 'MNIST':
        ...
        X_train, y_train = load_fmnist('/lustre/home/acct-eemrh/eemrh-u1/data/', kind='train')
        X_test, y_test = load_fmnist('/lustre/home/acct-eemrh/eemrh-u1/data/', kind='t10k')
...
def model_mnist(type):
    ...
    models = [model_cifar, modelA, modelB, modelC, modelD, modelE, modelF, modelG, model_LR]
